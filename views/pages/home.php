    ...
    <div class="container-project">
        ...
        <article class="container-article-project white">
            <div class="container-text-project">
                ...
                <p class="text-article">
                    Pour vous aider nous avons étudié pour <span class="bold">chaque symptôme</span> quel est
                    le <span class="bold">médicament le plus adapté</span>, ainsi, nous pouvons vous conseiller.
                </p>
                <p class="text-article">
                    De plus, vous trouverez pour chaque médicament des éléments utiles :
                </p>
                <ul>
                    <li><span class="bold">Notice simplifiée </span></li>
                    <li><span class="bold">Effets secondaires </span></li>
                    <li><span class="bold">Composition et mode d’emploi</span></li>
                </ul>

                <p class="text-article">
                    Ainsi que beaucoup d’autres informations.
